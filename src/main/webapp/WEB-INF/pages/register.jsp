...
<div class="center-block"
    ...
    <form id="registerForm" class="form-horizontal" role="form" action="${appPath}/register" method="post">
        ...
        <div class="form-group">
            <div class="col-sm-7 input-group text-right" style="margin: auto;">
                <input type="button" id="close_btn" class="btn btn-default" style="width: 70px;"
